...
import problems.iris.readers.stream_data as stream_data
from problems.iris.download_data.download_data import download
...
class Problem(ProblemBase):
    ...
    def get_feature_set_constructor(feature_set_name):
        if feature_set_name == 'default':
            import problems.iris.features.feature_sets.default.feature_set as default_features
